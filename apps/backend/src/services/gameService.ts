...
function chooseRandomTarget() {
  const targets = ["pomme", "banane", "orange", "kiwi", "fraise", "mangue", "ananas", "raisin", "cerise", "pêche", "abricot", "melon", "pastèque", "framboise", "myrtille", "cassis", "groseille", "clémentine", "mandarine",
